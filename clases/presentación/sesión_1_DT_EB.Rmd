...
background-image: url(img/mide_logo_2019.png), url(img/ku_leuven_logo.svg)
background-position: top left, top right
background-size: 20%, 20%

```{r echo=FALSE, out.width = '2%', out.height = '2%'}
#::include_graphics('./img/blank_space.png')
```

<br>

.line_space_07[
## Curso de Análisis Estadístico 2024
### .text_70[Introducción]
]
<br>

.text_100[Daniel Miranda, PhD.] .text_80[danmiranda@uchile.cl]

.text_100[Kevin Carrasco, MSc.] 
...
knitr::include_graphics('img/DMF.jpg')
```
]
...
knitr::include_graphics('img/Kevin.webp')
```
]
...
---
class: animated animate__rubberBand
...
- Conocer y aplicar las principales técnicas de análisis estadísticos


---
#  Objetivos Específicos 

  + Comprender conceptual y operacionalmente los conceptos procedentes de la estadística descriptiva.

  + Reconocer los contextos en que es pertinente –y en los que no- el uso de la estadística descriptiva.

  + Conocer y aplicar herramientas de tabulación y representación gráfica de datos.
  
  + Comprender conceptual y operacionalmente medidas de tendencia central (media, mediana, moda) y dispersión (varianza, desviación estándar, rango, rango intercuartil).

  + Comprender los fundamentos y propósitos de estadística inferencial


---
#  Contenidos 

Estadísticas, medición y escalas
-	¿Qué es la estadística?
-	La teoría de medición de S.S. Stevens
-	Tipos de variables y escalas de medición.

Estadística Descriptiva I
-	Distribución de frecuencia de variables
-	Descripción visual de datos y estadísticos univariados 
-	Tablas y gráficos para cruce de dos o más variables
...
-	Representación tabulada de datos
-	Representación gráfica de datos

Análisis de datos
-	Inferencia estadística
-	Distribución de probabilidades (normal estándar)
-	Análisis de medidas y toma de decisiones. 


---
#  Metodologías de enseñanza-aprendizaje que se emplearán en este curso

+ Metodologías a utilizar en sala de clases: 

  - Clases expositivas
  
  - Ejercicios pråcticos
 
  
---
#  Estructura básica 

+ Clases expositivas con ejemplos y actividades


+ Evaluaciones

  - Ejercicio práctico al final del curso

---
#  Aspectos prácticos 

- Todas las clases serán ejecutadas por dos profesores

- Todas las clases y material del curso se subirán al sitio web del curso (distribuidas por mail).
...
Regla:
Aceptar sólo como relaciones válidas entre los números aquellas que tengan sentido considerando el fenómeno estudiado
...
Estandarizan los puntajes, permitiendo su comparación
  - Proporción (p)
...
- Ejercicio de tabulación de datos


---
# Datos 

Los datos contienen información de 100 personas acerca de su edad y sexo (como se ve en la imagen).
...
Para el desarrollo de estos ejercicios, se provee un archivo excel con cuatro hojas (datos, frecuencia_edad(5), frecuencia_sexo, frecuencia_edad(10))

Mientras que las primeras hojas funcionan como ejemplo, la de frecuencia_edad(10) debe ser desarrollada una revisados los ejemplos. 


---
# Análisis de frecuencia del la edad

Para el análisis de frecuencia de edad se usa la hoja *frecuencia_edad (5)*, que contiene la edad agrupada en rangos de 5 años.
...
Para simplificar el análisis de frecuencias de la edad, primero se deben definir los rangos que serán analizados.

En este caso, la columna A define rangos de 5 en 5, inciando en 20 años hasta llegar a los 70 o más años. 

A partir de ahí se comienza con el uso de funciones que permiten hacer el conteo.
...
Función ***FRECUENCIA()*: esta permite contar la frecuencia de aparición de cierto rango de valores. Específicamente, al definir un valor máximo (p.e. 20) cuenta las apariciones hasta ese valor para cada fila. 

```{r echo=FALSE, out.width = '70%', fig.align='center'}
knitr::include_graphics('img/f3.png')
```

De la hoja de datos se define las celdas a contar y de la hoja actual las celdas que sirven de guía para contar los rangos específicos. Por ejemplo, la fila 2 cuenta personas de hasta 20 años, la fila 3 cuenta personas entre 21 y 25 años, la fila 4 cuenta personas entre 26 y 30 años, y así sucesivamente.

---
# Frecuencia de la edad

La frecuencia acumulada es una suma de las celdas inmediatamente anteriores + la celda actual.
...
La proporción es el $$ Proporción(p):  p = \frac{f}{N} $$

```{r echo=FALSE, out.width = '70%', fig.align='center'}
knitr::include_graphics('img/f6.png')
```

---
# Frecuencia de la edad

La proporción acumulada es una suma de las celdas inmediatamente anteriores + la celda actual.


```{r echo=FALSE, out.width = '70%', fig.align='center'}
knitr::include_graphics('img/f7.png')
```
...
El procentaje es $$ Porcentaje(\%):  \% = p \times 100 $$

```{r echo=FALSE, out.width = '70%', fig.align='center'}
knitr::include_graphics('img/f8.png')
```

---
# Frecuencia de la edad

El % acumulado ascendente es una suma de las celdas inmediatamente anteriores + la celda actual.
...
El % acumulado descendente es una suma de las celdas inmediatamente posteriores + la celda actual.

```{r echo=FALSE, out.width = '70%', fig.align='center'}
knitr::include_graphics('img/f10.png')
```

---
# Entonces, ¿qué se puede decir de este análisis?

```{r echo=FALSE, out.width = '70%', fig.align='center'}
knitr::include_graphics('img/f2.png')
```

- Entre los 20 y 45 años se encuentra un 54% de las personas.
- Sólo un 26% tiene más de 51 años. 
- Los valores más frecuentes se encuentran entre los 35 y los 55 años.
- Hay muy pocas personas menores de 30 y muy pocas personas mayores de 56.

---
# Frecuencia del sexo

```{r echo=FALSE, out.width = '90%', fig.align='center'}
knitr::include_graphics('img/f11.png')
```

---
# Ejercicio

Complete el análisis de frecuencia de la edad en rangos de 10 años. 
